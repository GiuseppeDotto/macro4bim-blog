...
views: 384
published: true
thumbnail: /media/structural-grids-thumbnail.gif
---
...
<span style={{ color: "red" }}>\*</span>as long as the Grid stays in the crop box, if not, it
automatically switches to 2D.
