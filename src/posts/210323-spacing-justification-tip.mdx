...
<p style={{ color: "#de5021" }}>
  In the case of <b>NurbsCurves</b>, a list of equally distributed and parametrized parameters does
  not return a list of equally distributed points on the curve, geometrically speaking.
</p>
