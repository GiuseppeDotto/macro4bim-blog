...
views: 5414
published: true
thumbnail: /media/vscode-intellisense-thumbnail.png
---
...
<span style={{ color: "red" }}>side note</span>: as suggested from [Gui
Talarico](https://www.linkedin.com/in/gtalarico/) "stubs would technically need to be generated for
each Revit API version and they haven't in a while, so stubs might be a little stale."
...
<center>
  <iframe
    width="560"
    height="315"
    src="https://www.youtube.com/embed/88zIQCZw8BA?si=xPaRMp9g3uZ4ABG8"
