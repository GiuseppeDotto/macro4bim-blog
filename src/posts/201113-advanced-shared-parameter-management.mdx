...
description: Shared Parameter are great, but sometime tedious. Here our workflow.
views: 899
votes: 3
tags:
  - Dynamo
...
<span style={{ color: "darkgrey" }}>
  However, for this post, I decided to go a little bit further and talk about what is inside the
  custom node and, more in detail, what are the ideas guarded in the{" "}
  <span style={{ color: "black" }}>Python</span> script!
  <br />
...
<pre>
  ReplaceParameter(
  <u>FamilyParameter</u> <i>currentParameter</i>,<u>ExternalDefinition</u> <i>familyDefinition</i>,<u>
    BuiltInParameterGroup
  </u> <i>parameterGroup</i>,<u>bool</u> <i>isInstance</i>)
</pre>
...
<pre>
  LoadFamily(
  <u>Document</u> <i>targetDocument</i>,<u>IFamilyLoadOptions</u> <i>familyLoadOptions</i>)
</pre>
